...
/* 2. 	Write a query to find the year when the movie Joels Jewel was released */
select mov_year
from movie
where mov_title like '%Joels jewel%';

/* 3. 	write a sql query to find the movie which was released in the year 1996 */
select mov_title
from movie
where mov_year in ('1996');
